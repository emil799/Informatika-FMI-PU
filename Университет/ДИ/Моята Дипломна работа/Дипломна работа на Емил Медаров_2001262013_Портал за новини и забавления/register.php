<?php
session_start();
include_once "config.php"; // Включваме конфигурационния файл за връзка с базата данни
include_once "db.php";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $dbname = "daily_Brief"; // Your database name
    ...
    // Prepare and bind
    $stmt = $conn->prepare("INSERT INTO users (username, user_password, userType, user_email, user_first_name, user_last_name) VALUES (?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssss", $username, $password_hash, $userType, $user_email, $user_first_name, $user_last_name);
...
<div class="form-container">
    ...
    <form id="form" action="register.php" method="post">
        ...
        <label for="user_password">Парола:<span>*</span></label>
        <input type="password" id="user_password" name="user_password" required><br>

        <label for="userType">Изберете роля:</label>
        <select id="userType" name="userType">
            <option value="client">Клиент</option>
            <option value="admin">Администратор</option>
        </select>

        <label for="user_email">Имейл:<span>*</span></label>
        <input type="email" id="user_email" name="user_email" required><br>

        <label for="user_first_name">Име:<span>*</span></label>
        <input type="text" id="user_first_name" name="user_first_name"><br>

        <label for="user_last_name">Фамилия:<span>*</span></label>
