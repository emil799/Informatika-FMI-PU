...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["delete_posts"]) && isset($_POST["category"])) {
        ...
        $sql = "DELETE FROM $table WHERE $idColumn IN ($postsIds) AND user_id = $user_id";
...
if ($selectedCategory) {
    ...
    switch ($selectedCategory) {
        case 'България':
            ...
            case 'Бизнес':
                ...
                case 'Забавления':
                    ...
                    if ($table) {
                        $sql = "SELECT $idColumn, $titleColumn, $descriptionColumn, $photoColumn, date_published, user_id FROM $table
        ...
        if ($result->num_rows > 0) {
            $postsHTML .= "<form class='delete-post' action='delete-client-post.php' method='post'>";
...
<nav>
    ...
    <div class="form-container">
        ...
        <form action="delete-client-post.php" method="get">
